...
#SBATCH -J fe-arm-new-nlopt
#SBATCH -o /home/gridsan/ihammond/firstepoch-compare-20260629/arm-new-nlopt/slurm-%j.out
...
julia --project="$FIRSTEPOCH_NEW_ROOT" "$SCRIPTS/arm_new_nlopt.jl"
echo "exit $? at $(date)"
