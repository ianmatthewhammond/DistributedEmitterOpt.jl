...
# Paper configuration: freeform metal, nominal (3D DOFs, elastic)
# This mirrors figures/paper-figures-scripts/data/Freeform_Metal/nominal/output.txt.

# Output directory for mesh + optimization artifacts
name = "freeform_metal_nominal"
...
# Simulation: freeform (3D DOFs), Helmholtz filter
...
# Control: Helmholtz filter (use_dct=false), SSP projection + constraints
control = Control(
    use_filter=true,
