...
# This script is fully self-contained and mirrors the parameter dump in
# figures/paper-figures-scripts/data/Constrained_Metal/nominal/output.txt.

# Output directory for mesh + optimization artifacts
name = "constrained_metal_nominal"
