"""
    New-code debug script (sandbox config): isotropic tensor, 3D DOFs, volume objective, elastic.

Run from REPL:
    julia> include("scripts/experiments/isotropic_3d_volume_new_sandbox/debug_isotropic_3d_volume_new_sandbox.jl")
"""
...
println("\n=== New-code Debug (sandbox config): isotropic, 3D DOF, volume objective, elastic ===")
